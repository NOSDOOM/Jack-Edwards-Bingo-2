$(document).ready(function() {
	...
	for (i=0; i<24; i++)	{
		...
		if (i==12) {
			$('#board').append("<div data-value='1' class='selected freesquare' id='sqfree'><div class='text'><br/></a></div>");
	...
	$('div.square').tappable(function () {
      ...
      if ($(this).data('value') == 1) {
		...
		if (row1 == 5 || row2 == 5 || row3 == 5 || row4 == 5 || row5 == 5 || col1 == 5 || col2 == 5 || col3 == 5  || col4 == 5  || col5 == 5 || diag1 == 5 || diag2 == 5) {
            ...
            document.getElementById('loadingImage').load();
    			setTimeout(function() {
                document.getElementById('loadingImage').style.visibility='hidden';
                					    var x;       
    if (confirm("Play Again?") == true) {
        x = $('div.square').removeClass('selected');
